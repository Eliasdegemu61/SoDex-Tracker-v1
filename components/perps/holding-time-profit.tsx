        ...
        >
          <ResponsiveContainer width="100%" height={isMobile ? 280 : 350}>
            <ScatterChart
              ...
              data={chartData}
            >
              <CartesianGrid strokeDasharray="3 3" stroke="currentColor" opacity={0.1} pointerEvents="none" />
              <XAxis
                type="number"
                dataKey="holdingTime"
                ...
                label={!isMobile ? { value: 'Holding Time (hours)', position: 'insideBottomRight', offset: -5, style: { fontSize: '12px' } } : undefined}
              />
              <YAxis
                type="number"
                dataKey="profit"
                ...
                opacity={0.5}
                style={{ fontSize: isMobile ? '10px' : '12px' }}
                label={!isMobile ? { value: 'Profit ($)', angle: -90, position: 'insideLeft', style: { fontSize: '12px' } } : undefined}
              />
              <Tooltip
                ...
                cursor={false}
              />
              <ReferenceLine y={0} stroke="currentColor" opacity={0.2} strokeDasharray="3 3" pointerEvents="none" />
              <Scatter
