...
import { AccountBalance } from '@/components/perps/account-balance'
import { TradingPerformance1W } from '@/components/perps/trading-performance-1w'
import { PositionsOverview } from '@/components/perps/positions-overview'
              ...
              perpsData && (
                <div>
                  ...
                  {!addressError && perpsData && (
                    <>
                      {/* New Balance and Trading Performance Features */}
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                        <AccountBalance perpetualBalance={walletBalance} spotBalance={spotBalance} />
                        <TradingPerformance1W history={perpsData.history} />
                      </div>

                      {/* Open Positions Overview */}
                      <PositionsOverview positions={perpsData.positions} perpBalance={walletBalance} />
                      ...
                      <div className="space-y-6 pt-8">
                          {(() => {
                            ...
                            return (
                              <>
                                {/* Calendar and PNL Charts at Top */}
                                ...
                                {/* All Metrics Under One Card */}
                                <div className="backdrop-blur-sm bg-white/5 dark:bg-white/5 border border-white/10 dark:border-white/10 rounded-lg p-4 sm:p-6 shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] dark:shadow-[0_4px_20px_-2px_rgba(0,0,0,0.3)]">
                                  {/* Stat Cards Grid */}
                                  <div className="mb-6">
                                    <p className="text-xs sm:text-sm font-semibold uppercase tracking-widest text-muted-foreground/70 mb-4">Key Metrics</p>
                                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4">
                                      {/* Futures Fees Paid */}
                                      <div className="bg-secondary rounded p-2.5 sm:p-3">
                                        <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Futures Fees</p>
                                        <p className="text-sm sm:text-lg font-bold text-destructive">${analytics.totalFeesPaid.toFixed(2)}</p>
                                      </div>

                                      {/* Total PnL */}
                                      <div className="bg-secondary rounded p-2.5 sm:p-3">
                                        <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Total PnL</p>
                                        <p className={`text-sm sm:text-lg font-bold ${analytics.totalPnl >= 0 ? 'text-success' : 'text-destructive'}`}>
                                      ...
                                      {/* ROI */}
                                      <div className="bg-secondary rounded p-2.5 sm:p-3">
                                        <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">ROI</p>
                                        <p className={`text-sm sm:text-lg font-bold ${analytics.roi >= 0 ? 'text-success' : 'text-destructive'}`}>
                                      ...
                                      {/* Avg Holding Time */}
                                      <div className="bg-secondary rounded p-2.5 sm:p-3">
                                        <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Avg Hold</p>
                                        <p className="text-sm sm:text-lg font-bold">{analytics.avgHoldingTime.toFixed(1)}h</p>
                                      </div>

                                      {/* Max Drawdown */}
                                      <div className="bg-secondary rounded p-2.5 sm:p-3">
                                        <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Max Draw</p>
                                        <p className="text-sm sm:text-lg font-bold text-destructive">${analytics.maxDrawdown.toFixed(2)}</p>
                                      </div>

                                      {/* Futures Volume */}
                                      <div className="bg-secondary rounded p-2.5 sm:p-3">
                                        <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Futures Vol</p>
                                        <p className="text-sm sm:text-lg font-bold">${parseFloat(cumulativeVolume).toLocaleString('en-US', { maximumFractionDigits: 0 })}</p>
                                      </div>

                                      {/* Spot Balance */}
                                      <div className="bg-secondary rounded p-2.5 sm:p-3">
                                        <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Spot Bal</p>
                                        <p className="text-sm sm:text-lg font-bold">${parseFloat(spotBalance).toFixed(2)}</p>
                                      </div>

                                      {/* Perps Balance */}
                                      <div className="bg-secondary rounded p-2.5 sm:p-3">
                                        <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Perps Bal</p>
                                        <p className="text-sm sm:text-lg font-bold">${parseFloat(walletBalance).toFixed(2)}</p>
                                      </div>

                                      {/* Spot Volume */}
                                      <div className={`bg-secondary rounded p-2.5 sm:p-3 ${!spotTradesLoading ? 'animate-fade-in-up' : ''}`}>
                                        <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Spot Vol</p>
                                        {spotTradesLoading ? (
                                          <div className="flex items-center gap-1">
                                            <div className="w-3 h-3 border-2 border-primary border-t-transparent rounded-full animate-spin" />
                                          </div>
                                        ) : (
                                          <p className="text-sm sm:text-lg font-bold">${parseFloat(spotVolumeUsd || '0').toFixed(2)}</p>
                                        )}
                                      </div>

                                      {/* Spot Fees Paid */}
                                      <div className={`bg-secondary rounded p-2.5 sm:p-3 ${!spotTradesLoading ? 'animate-fade-in-up' : ''}`}>
                                        <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Spot Fees</p>
                                        {spotTradesLoading ? (
                                          <div className="flex items-center gap-1">
                                            <div className="w-3 h-3 border-2 border-primary border-t-transparent rounded-full animate-spin" />
                                          </div>
                                        ) : (
                                          <p className="text-sm sm:text-lg font-bold text-destructive">${parseFloat(spotFeesUsd || '0').toFixed(6)}</p>
                                        )}
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  {/* Trade Cards Grid */}
                                  <div>
                                    <p className="text-xs sm:text-sm font-semibold uppercase tracking-widest text-muted-foreground/70 mb-4">Trade Highlights</p>
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                      {/* Best Trade */}
                                      <div className="bg-white/3 dark:bg-white/3 rounded p-3 sm:p-4">
                                        <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground/60 mb-2">Best Trade</p>
                                        {analytics.bestTrade ? (
                                          <div className="space-y-1">
                                            <p className="text-xs sm:text-sm font-semibold text-muted-foreground">{analytics.bestTrade.symbol_name || `Symbol-${analytics.bestTrade.symbol_id}`}</p>
                                            <p className="text-sm sm:text-base font-bold text-success">${parseFloat(analytics.bestTrade.realized_pnl).toFixed(2)}</p>
                                            <p className="text-[8px] sm:text-xs text-muted-foreground/50">Entry: ${parseFloat(analytics.bestTrade.avg_entry_price).toFixed(2)}</p>
                                            <p className="text-[8px] sm:text-xs text-muted-foreground/50">Exit: ${parseFloat(analytics.bestTrade.avg_close_price).toFixed(2)}</p>
                                          </div>
                                        ) : (
                                      ...
                                      {/* Worst Trade */}
                                      <div className="bg-white/3 dark:bg-white/3 rounded p-3 sm:p-4">
                                        <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground/60 mb-2">Worst Trade</p>
                                        {analytics.worstTrade ? (
                                          <div className="space-y-1">
                                            <p className="text-xs sm:text-sm font-semibold text-muted-foreground">{analytics.worstTrade.symbol_name || `Symbol-${analytics.worstTrade.symbol_id}`}</p>
                                            <p className="text-sm sm:text-base font-bold text-destructive">${parseFloat(analytics.worstTrade.realized_pnl).toFixed(2)}</p>
                                            <p className="text-[8px] sm:text-xs text-muted-foreground/50">Entry: ${parseFloat(analytics.worstTrade.avg_entry_price).toFixed(2)}</p>
                                            <p className="text-[8px] sm:text-xs text-muted-foreground/50">Exit: ${parseFloat(analytics.worstTrade.avg_close_price).toFixed(2)}</p>
                                          </div>
                                        ) : (
                                      ...
                                      {/* Top Pair */}
                                      <div className="bg-white/3 dark:bg-white/3 rounded p-3 sm:p-4">
                                        <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground/60 mb-2">Top Pair</p>
                                        {analytics.mostTradedPair ? (
                                          <div className="space-y-1">
                                            <p className="text-sm sm:text-base font-bold">{analytics.mostTradedPair}</p>
                                            <p className="text-[8px] sm:text-xs text-muted-foreground/50">Highest trade frequency</p>
                                          </div>
                                        ) : (
                                          <p className="text-xs text-muted-foreground">No data</p>
                                        )}
                      ...
                      <div className="border rounded-lg overflow-hidden">
                        <button
                          ...
                          className="w-full p-4 bg-secondary/50 hover:bg-secondary/70 flex items-center justify-between text-left transition-colors"
                        >
                          <span className="font-semibold">Open Positions ({perpsData.positions.length})</span>
                          <Button
                            size="sm"
                            variant="default"
                            onClick={(e) => {
                              e.stopPropagation();
                              setPositionView(positionView === 'open' ? null : 'open');
                            }}
                          >
                            View Open Position
                          </Button>
                      ...
                      <div className="border rounded-lg overflow-hidden">
                        ...
                        >
                          <span className="font-semibold">Position History ({positionHistoryCount})</span>
                          <Button
                            size="sm"
                            variant="default"
                            onClick={(e) => {
                              e.stopPropagation();
                              setPositionView(positionView === 'history' ? null : 'history');
                            }}
                            disabled={historyLoading}
                          >
            ...
            {!portfolioBoundAddress ? (
              ...
              <div className="space-y-4 sm:space-y-8">
                ...
                {portfolioLoading ? (
                  ...
                  <>
                    {/* New Balance and Trading Performance Features - Top */}
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                      <AccountBalance perpetualBalance={portfolioBalance} spotBalance={portfolioSpotBalance} />
                      <TradingPerformance1W history={portfolioData.history} />
                    </div>

                    {/* Open Positions Overview */}
                    <PositionsOverview positions={portfolioData.positions} perpBalance={portfolioBalance} />
                        ...
                        {(() => {
                          ...
                          return (
                            <>
                              ...
                              <div className="bg-card border border-border rounded-lg p-4 sm:p-6">
                                ...
                                <div className="mb-6">
                                  ...
                                  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4">
                                    ...
                                    <div className="bg-secondary rounded p-2.5 sm:p-3">
                                      <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Futures Vol</p>
                                      <p className="text-sm sm:text-lg font-bold">${parseFloat(portfolioCumulativeVolume).toLocaleString('en-US', { maximumFractionDigits: 0 })}</p>
                                    </div>

                                    {/* Spot Balance */}
                                    <div className="bg-secondary rounded p-2.5 sm:p-3">
                                      <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Spot Bal</p>
                                      <p className="text-sm sm:text-lg font-bold">${parseFloat(portfolioSpotBalance.toString()).toFixed(2)}</p>
                                    </div>

                                    {/* Perps Balance */}
                                    <div className="bg-secondary rounded p-2.5 sm:p-3">
                                      <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Perps Bal</p>
                                      <p className="text-sm sm:text-lg font-bold">${parseFloat(portfolioBalance).toFixed(2)}</p>
                                    </div>

                                    {/* Spot Volume */}
                                    <div className={`bg-secondary rounded p-2.5 sm:p-3 ${!portfolioSpotTradesLoading ? 'animate-fade-in-up' : ''}`}>
                                      <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Spot Vol</p>
                                      {portfolioSpotTradesLoading ? (
                                        ...
                                        <p className="text-sm sm:text-lg font-bold">${parseFloat(portfolioSpotVolumeUsd || '0').toFixed(2)}</p>
                                      )}
                                    </div>
                                    ...
                                    <div className={`bg-secondary rounded p-2.5 sm:p-3 ${!portfolioSpotTradesLoading ? 'animate-fade-in-up' : ''}`}>
                                      ...
                                      {portfolioSpotTradesLoading ? (
                                        ...
                                        <p className="text-sm sm:text-lg font-bold text-destructive">${parseFloat(portfolioSpotFeesUsd || '0').toFixed(6)}</p>
                                      )}
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div>
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                    {/* Best Trade */}
                                    <div className="bg-secondary rounded p-3 sm:p-4">
                                      <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-2">Best Trade</p>
                                      {analytics.bestTrade ? (
                                        <div className="space-y-1">
                                          <p className="text-xs sm:text-sm font-semibold text-muted-foreground">{analytics.bestTrade.symbol_name || `Symbol-${analytics.bestTrade.symbol_id}`}</p>
                                          <p className="text-sm sm:text-base font-bold text-success">${parseFloat(analytics.bestTrade.realized_pnl).toFixed(2)}</p>
                                    ...
                                    {/* Worst Trade */}
                                    <div className="bg-secondary rounded p-3 sm:p-4">
                                      <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-2">Worst Trade</p>
                                      {analytics.worstTrade ? (
                                        <div className="space-y-1">
                                          <p className="text-xs sm:text-sm font-semibold text-muted-foreground">{analytics.worstTrade.symbol_name || `Symbol-${analytics.worstTrade.symbol_id}`}</p>
                                          <p className="text-sm sm:text-base font-bold text-destructive">${parseFloat(analytics.worstTrade.realized_pnl).toFixed(2)}</p>
                                    ...
                                    {/* Top Pair */}
                                    <div className="bg-secondary rounded p-3 sm:p-4">
                                      <p className="text-[9px] sm:text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-2">Top Pair</p>
                                      {analytics.mostTradedPair ? (
                                        <div className="space-y-1">
                                          <p className="text-sm sm:text-base font-bold">{analytics.mostTradedPair}</p>
                                          <p className="text-[8px] sm:text-xs text-muted-foreground/50">Highest trade frequency</p>
                              ...
                              {/* Portfolio Position View Tabs - At Bottom */}
